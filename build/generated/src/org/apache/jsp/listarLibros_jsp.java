...
for (Libro l : Librodao.listar()) {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"table-header\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tResultados de Editorial Registrado\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- div.table-responsive -->\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tSitio Web\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">Telefono</th>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</thead>\n");
...
for (Editorial edi :    EditorialDao. listar()) {
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(edi. getEmail());
      out.write("</td>\n");
      out.write("                                                                                                                \n");
      out.write("                                                                                                                <td>");
      out.print(edi. getSitioweb() );
      out.write("</td>\n");
      out.write("                                                                                                                <td>");
      out.print(edi. getTelefono());
      out.write("</td>\n");
      out.write("                                                                                                                <td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"hidden-sm hidden-xs action-buttons\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"blue\" href=\"#\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"table-header\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tResultados de Categoria Registrado\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- div.table-responsive -->\n");
      out.write("\n");
