						...
						<div class="page-header">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-header">
											Resultados de Editorial Registrado
										</div>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                                                        ...
                                                                                        <%for (Editorial edi :    EditorialDao. listar()) {%>
													<tr>

														<td>
														<a href="#"><%=edi. getNit()%></a>
														</td>
														<td class="hidden-480"><%=edi. getNombre()%></td>
														<td><%=edi. getDireccion()%></td>

														<td><%=edi. getEmail()%></td>
                                                                                                                
                                                                                                                <td><%=edi. getSitioweb() %></td>
						...
						<div class="page-header">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-header">
											Resultados de Categoria Registrado
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
														<a href="#"><%=cat. getCodigo()%></a>
														</td>
														<td class="hidden-480"><%=cat. getNombre()%></td>
														<td><%=cat. getAutor()%></td>
